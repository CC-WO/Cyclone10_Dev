...
SIGNAL \m_led2_cnt1~3_combout\ : std_logic;
...
-- Equation(s):
-- \U_CLOCK_1ms|cnt~5_combout\ = (!\U_CLOCK_1ms|Equal0~4_combout\ & \U_CLOCK_1ms|Add1~6_combout\)
...
-- Equation(s):
-- \U_CLOCK_1ms|cnt~4_combout\ = (\U_CLOCK_1ms|Add1~10_combout\ & !\U_CLOCK_1ms|Equal0~4_combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \U_CLOCK_1ms|Add1~10_combout\,
...
-- Equation(s):
-- \U_CLOCK_1ms|cnt~3_combout\ = (\U_CLOCK_1ms|Add1~14_combout\ & !\U_CLOCK_1ms|Equal0~4_combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \U_CLOCK_1ms|Add1~14_combout\,
	datad => \U_CLOCK_1ms|Equal0~4_combout\,
...
PORT MAP (
	...
	datad => \U_CLOCK_1ms|Add1~16_combout\,
...
PORT MAP (
	datac => \U_CLOCK_1ms|Equal0~4_combout\,
	datad => \U_CLOCK_1ms|Add1~26_combout\,
...
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~0_combout\ = (\U_CLOCK_1ms|cnt\(14) & (\U_CLOCK_1ms|cnt\(13) & (!\U_CLOCK_1ms|cnt\(12) & !\U_CLOCK_1ms|cnt\(15))))
...
PORT MAP (
	...
	datac => \U_CLOCK_1ms|cnt\(12),
	datad => \U_CLOCK_1ms|cnt\(15),
	combout => \U_CLOCK_1ms|Equal0~0_combout\);

-- Location: LCCOMB_X1_Y9_N30
\U_CLOCK_1ms|Equal0~1\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~1_combout\ = (!\U_CLOCK_1ms|cnt\(9) & (\U_CLOCK_1ms|cnt\(8) & (!\U_CLOCK_1ms|cnt\(10) & !\U_CLOCK_1ms|cnt\(11))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_CLOCK_1ms|cnt\(9),
	datab => \U_CLOCK_1ms|cnt\(8),
	datac => \U_CLOCK_1ms|cnt\(10),
...
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~2_combout\ = (\U_CLOCK_1ms|cnt\(5) & (\U_CLOCK_1ms|cnt\(7) & (!\U_CLOCK_1ms|cnt\(4) & !\U_CLOCK_1ms|cnt\(6))))
...
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~4_combout\ = (\U_CLOCK_1ms|Equal0~3_combout\ & (\U_CLOCK_1ms|Equal0~0_combout\ & (\U_CLOCK_1ms|Equal0~1_combout\ & \U_CLOCK_1ms|Equal0~2_combout\)))
...
PORT MAP (
	...
	datac => \U_CLOCK_1ms|Equal0~1_combout\,
...
-- pragma translate_on
PORT MAP (
	datad => \U_CLOCK_1ms|clk_tmp~0_combout\,
...
\m_led2_cnt1~3\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \m_led2_cnt1~3_combout\ = (\Add1~0_combout\ & ((!\Equal0~1_combout\) # (!\Equal0~0_combout\)))
...
-- Equation(s):
-- \Equal0~1_combout\ = (m_led2_cnt1(2) & (!m_led2_cnt1(0) & (!m_led2_cnt1(1) & !m_led2_cnt1(3))))
...
-- Equation(s):
-- \m_led2_cnt1~2_combout\ = (\Add1~4_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~1_combout\)))
...
-- Equation(s):
-- \m_led2_cnt1~1_combout\ = (\Add1~10_combout\ & ((!\Equal0~1_combout\) # (!\Equal0~0_combout\)))
...
-- Equation(s):
-- \m_led2_cnt1~0_combout\ = (\Add1~12_combout\ & ((!\Equal0~0_combout\) # (!\Equal0~1_combout\)))
...
-- Equation(s):
-- \Equal0~0_combout\ = (m_led2_cnt1(5) & (m_led2_cnt1(6) & (!m_led2_cnt1(7) & !m_led2_cnt1(4))))
...
-- Equation(s):
-- \m_led2_cnt2[0]~1_combout\ = m_led2_cnt2(0) $ (((\Equal0~0_combout\ & \Equal0~1_combout\)))
...
-- Equation(s):
-- \U_KEY2|Equal0~0_combout\ = (\U_KEY2|chatt3\(2) & (\U_KEY2|chatt3\(3) & (!\U_KEY2|chatt3\(1) & !\U_KEY2|chatt3\(0))))
...
-- Equation(s):
-- \U_KEY0|chatt2~0_combout\ = (\U_KEY0|chatt1\(3)) # ((\U_KEY0|chatt1\(2)) # ((\U_KEY0|chatt1\(0)) # (\U_KEY0|chatt1\(1))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY0|chatt1\(3),
	datab => \U_KEY0|chatt1\(2),
	datac => \U_KEY0|chatt1\(0),
	datad => \U_KEY0|chatt1\(1),
...
-- Equation(s):
-- \U_KEY0|Equal0~0_combout\ = (\U_KEY0|chatt3\(3) & (\U_KEY0|chatt3\(2) & (!\U_KEY0|chatt3\(0) & !\U_KEY0|chatt3\(1))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY0|chatt3\(3),
	datab => \U_KEY0|chatt3\(2),
	datac => \U_KEY0|chatt3\(0),
	datad => \U_KEY0|chatt3\(1),
...
-- Equation(s):
-- \U_KEY3|chatt2~0_combout\ = (\U_KEY3|chatt1\(1)) # ((\U_KEY3|chatt1\(0)) # ((\U_KEY3|chatt1\(3)) # (\U_KEY3|chatt1\(2))))
...
-- Equation(s):
-- \U_KEY3|Equal0~0_combout\ = (\U_KEY3|chatt3\(2) & (\U_KEY3|chatt3\(3) & (!\U_KEY3|chatt3\(0) & !\U_KEY3|chatt3\(1))))
...
-- Equation(s):
-- \U_KEY1|Equal0~0_combout\ = (!\U_KEY1|chatt3\(1) & (!\U_KEY1|chatt3\(0) & (\U_KEY1|chatt3\(2) & \U_KEY1|chatt3\(3))))
...
PORT MAP (
	...
	datab => \U_KEY1|chatt3\(0),
	datac => \U_KEY1|chatt3\(2),
	datad => \U_KEY1|chatt3\(3),
...
-- Equation(s):
-- \Equal3~0_combout\ = (!\U_KEY2|sw_ena~q\ & (\U_KEY0|sw_ena~q\ & (!\U_KEY3|sw_ena~q\ & !\U_KEY1|sw_ena~q\)))
...
-- Equation(s):
-- \sele~0_combout\ = (\U_KEY2|sw_ena~q\ & (!\U_KEY1|sw_ena~q\ & (!\U_KEY0|sw_ena~q\ & !\U_KEY3|sw_ena~q\))) # (!\U_KEY2|sw_ena~q\ & ((\U_KEY1|sw_ena~q\ & (!\U_KEY0|sw_ena~q\ & !\U_KEY3|sw_ena~q\)) # (!\U_KEY1|sw_ena~q\ & (\U_KEY0|sw_ena~q\ $ 
-- (\U_KEY3|sw_ena~q\)))))
...
-- Equation(s):
-- \m_led2_cnt2[1]~0_combout\ = m_led2_cnt2(1) $ (((m_led2_cnt2(0) & (\Equal0~0_combout\ & \Equal0~1_combout\))))
...
-- Equation(s):
-- \Equal5~0_combout\ = (!\U_KEY1|sw_ena~q\ & (!\U_KEY3|sw_ena~q\ & (!\U_KEY0|sw_ena~q\ & \U_KEY2|sw_ena~q\)))
...
-- Equation(s):
-- \Equal4~0_combout\ = (!\U_KEY2|sw_ena~q\ & (!\U_KEY0|sw_ena~q\ & (!\U_KEY3|sw_ena~q\ & \U_KEY1|sw_ena~q\)))
...
-- Equation(s):
-- \Mux7~0_combout\ = (sele(1) & ((m_led2_cnt2(1)) # ((sele(2)) # (sele(3))))) # (!sele(1) & ((sele(2) $ (!sele(3)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1111110011100011",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => m_led2_cnt2(1),
...
-- Equation(s):
-- \Mux7~1_combout\ = (m_led2_cnt2(0)) # ((sele(0)) # (\Mux7~0_combout\))
...
-- Equation(s):
-- \Mux6~1_combout\ = (!sele(1) & (!m_led2_cnt2(0) & !sele(2)))
...
-- Equation(s):
-- \m_led3_cnt2[2]~0_combout\ = (m_led2_cnt2(1) & (m_led2_cnt2(0) & (\Equal0~0_combout\ & \Equal0~1_combout\)))
...
-- Equation(s):
-- \Mux5~1_combout\ = (sele(1) & ((sele(2)) # ((m_led2_cnt2(1) & !\Mux5~0_combout\)))) # (!sele(1) & (((\Mux5~0_combout\))))
...
-- Equation(s):
-- \Mux5~2_combout\ = (sele(0)) # ((sele(2) & ((\Mux5~1_combout\))) # (!sele(2) & ((m_led2_cnt2(0)) # (!\Mux5~1_combout\))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (sele(0)) # ((m_led3_cnt2(3) & sele(2)))
