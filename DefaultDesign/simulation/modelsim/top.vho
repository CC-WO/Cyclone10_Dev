...
SIGNAL \U_LED_KEY2|Equal0~1_combout\ : std_logic;
SIGNAL \U_LED_KEY2|led_cnt2[0]~0_combout\ : std_logic;
...
SIGNAL \U_LED_KEY2|led_cnt2[1]~1_combout\ : std_logic;
SIGNAL \Mux3~0_combout\ : std_logic;
SIGNAL \Mux0~2_combout\ : std_logic;
SIGNAL \U_LED_KEY3|led_reg[0]~0_combout\ : std_logic;
SIGNAL \Mux3~1_combout\ : std_logic;
SIGNAL \Mux0~3_combout\ : std_logic;
SIGNAL \U_LED_KEY2|Mux2~0_combout\ : std_logic;
...
SIGNAL \U_LED_KEY2|Mux0~0_combout\ : std_logic;
...
SIGNAL \U_LED_KEY2|led_cnt2\ : std_logic_vector(1 DOWNTO 0);
...
-- Equation(s):
-- \U_CLOCK_1ms|cnt~2_combout\ = (\U_CLOCK_1ms|Add1~16_combout\ & !\U_CLOCK_1ms|Equal0~4_combout\)
...
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~1_combout\ = (\U_CLOCK_1ms|cnt\(8) & (!\U_CLOCK_1ms|cnt\(10) & (!\U_CLOCK_1ms|cnt\(11) & !\U_CLOCK_1ms|cnt\(9))))
...
PORT MAP (
	...
	datab => \U_CLOCK_1ms|cnt\(10),
	datac => \U_CLOCK_1ms|cnt\(11),
	datad => \U_CLOCK_1ms|cnt\(9),
...
-- Equation(s):
-- \U_CLOCK_1ms|cnt~1_combout\ = (\U_CLOCK_1ms|Add1~26_combout\ & !\U_CLOCK_1ms|Equal0~4_combout\)
...
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~2_combout\ = (!\U_CLOCK_1ms|cnt\(4) & (\U_CLOCK_1ms|cnt\(7) & (\U_CLOCK_1ms|cnt\(5) & !\U_CLOCK_1ms|cnt\(6))))
...
-- pragma translate_on
PORT MAP (
	datab => \U_CLOCK_1ms|clk_tmp~0_combout\,
...
-- Equation(s):
-- \U_KEY4|chatt2~0_combout\ = (\U_KEY4|chatt1\(2) & (\U_KEY4|chatt1\(1) & (\U_KEY4|chatt1\(3) & \U_KEY4|chatt1\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY4|chatt1\(2),
	datab => \U_KEY4|chatt1\(1),
...
-- Equation(s):
-- \U_KEY4|Equal0~0_combout\ = (\U_KEY4|chatt3\(1) & (!\U_KEY4|chatt3\(0) & (\U_KEY4|chatt3\(3) & \U_KEY4|chatt3\(2))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY4|chatt3\(1),
	datab => \U_KEY4|chatt3\(0),
...
-- Equation(s):
-- \U_KEY3|Equal0~0_combout\ = (\U_KEY3|chatt3\(2) & (\U_KEY3|chatt3\(1) & (\U_KEY3|chatt3\(3) & !\U_KEY3|chatt3\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY3|chatt3\(2),
	datab => \U_KEY3|chatt3\(1),
...
PORT MAP (
	clk => \U_CLOCK_1ms|clk_tmp~clkctrl_outclk\,
	asdata => \U_KEY3|Equal0~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \U_KEY3|sw_ena~q\);
...
-- Equation(s):
-- \U_KEY2|chatt2~0_combout\ = (\U_KEY2|chatt1\(1) & (\U_KEY2|chatt1\(0) & (\U_KEY2|chatt1\(3) & \U_KEY2|chatt1\(2))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY2|chatt1\(1),
	datab => \U_KEY2|chatt1\(0),
...
-- Equation(s):
-- \U_KEY2|Equal0~0_combout\ = (\U_KEY2|chatt3\(1) & (!\U_KEY2|chatt3\(0) & (\U_KEY2|chatt3\(2) & \U_KEY2|chatt3\(3))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY2|chatt3\(1),
	datab => \U_KEY2|chatt3\(0),
...
-- Equation(s):
-- \U_KEY1|chatt2~0_combout\ = (\U_KEY1|chatt1\(2) & (\U_KEY1|chatt1\(1) & (\U_KEY1|chatt1\(3) & \U_KEY1|chatt1\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY1|chatt1\(2),
	datab => \U_KEY1|chatt1\(1),
	datac => \U_KEY1|chatt1\(3),
	datad => \U_KEY1|chatt1\(0),
...
-- Equation(s):
-- \U_KEY1|Equal0~0_combout\ = (\U_KEY1|chatt3\(2) & (\U_KEY1|chatt3\(1) & (\U_KEY1|chatt3\(3) & !\U_KEY1|chatt3\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY1|chatt3\(2),
	datab => \U_KEY1|chatt3\(1),
...
-- Equation(s):
-- \Equal1~0_combout\ = (!\U_KEY4|sw_ena~q\ & (!\U_KEY3|sw_ena~q\ & (\U_KEY2|sw_ena~q\ & !\U_KEY1|sw_ena~q\)))
...
-- Equation(s):
-- \m_sele~1_combout\ = (\U_KEY4|sw_ena~q\ & (!\U_KEY2|sw_ena~q\ & (!\U_KEY3|sw_ena~q\ & !\U_KEY1|sw_ena~q\))) # (!\U_KEY4|sw_ena~q\ & ((\U_KEY2|sw_ena~q\ & (!\U_KEY3|sw_ena~q\ & !\U_KEY1|sw_ena~q\)) # (!\U_KEY2|sw_ena~q\ & (\U_KEY3|sw_ena~q\ $ 
-- (\U_KEY1|sw_ena~q\)))))
...
PORT MAP (
	dataa => \U_KEY4|sw_ena~q\,
	datab => \U_KEY2|sw_ena~q\,
	datac => \U_KEY3|sw_ena~q\,
	datad => \U_KEY1|sw_ena~q\,
...
-- Equation(s):
-- \Equal0~0_combout\ = (!\U_KEY4|sw_ena~q\ & (\U_KEY1|sw_ena~q\ & (!\U_KEY2|sw_ena~q\ & !\U_KEY3|sw_ena~q\)))
...
-- Equation(s):
-- \U_LED_KEY1|led_cnt~2_combout\ = (\U_LED_KEY1|Add0~4_combout\ & ((!\U_LED_KEY2|Equal0~0_combout\) # (!\U_LED_KEY2|Equal0~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY2|Equal0~1_combout\,
	datab => \U_LED_KEY2|Equal0~0_combout\,
...
-- Equation(s):
-- \U_LED_KEY1|led_cnt~1_combout\ = (\U_LED_KEY1|Add0~10_combout\ & ((!\U_LED_KEY2|Equal0~0_combout\) # (!\U_LED_KEY2|Equal0~1_combout\)))
...
PORT MAP (
	...
	datad => \U_LED_KEY2|Equal0~0_combout\,
...
-- Equation(s):
-- \U_LED_KEY1|led_cnt~0_combout\ = (\U_LED_KEY1|Add0~12_combout\ & ((!\U_LED_KEY2|Equal0~0_combout\) # (!\U_LED_KEY2|Equal0~1_combout\)))
...
-- Equation(s):
-- \U_LED_KEY2|Equal0~0_combout\ = (\U_LED_KEY1|led_cnt\(5) & (\U_LED_KEY1|led_cnt\(6) & (!\U_LED_KEY1|led_cnt\(7) & !\U_LED_KEY1|led_cnt\(4))))
...
-- Equation(s):
-- \U_LED_KEY1|led_cnt~3_combout\ = (\U_LED_KEY1|Add0~0_combout\ & ((!\U_LED_KEY2|Equal0~0_combout\) # (!\U_LED_KEY2|Equal0~1_combout\)))
...
PORT MAP (
	dataa => \U_LED_KEY2|Equal0~1_combout\,
	datab => \U_LED_KEY2|Equal0~0_combout\,
	datad => \U_LED_KEY1|Add0~0_combout\,
...
\U_LED_KEY2|Equal0~1\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_LED_KEY2|Equal0~1_combout\ = (!\U_LED_KEY1|led_cnt\(1) & (!\U_LED_KEY1|led_cnt\(0) & (\U_LED_KEY1|led_cnt\(2) & !\U_LED_KEY1|led_cnt\(3))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY1|led_cnt\(1),
	datab => \U_LED_KEY1|led_cnt\(0),
	datac => \U_LED_KEY1|led_cnt\(2),
	datad => \U_LED_KEY1|led_cnt\(3),
	combout => \U_LED_KEY2|Equal0~1_combout\);

-- Location: LCCOMB_X28_Y10_N8
\U_LED_KEY2|led_cnt2[0]~0\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_LED_KEY2|led_cnt2[0]~0_combout\ = \U_LED_KEY2|led_cnt2\(0) $ (((\U_LED_KEY2|Equal0~1_combout\ & \U_LED_KEY2|Equal0~0_combout\)))
...
PORT MAP (
	dataa => \U_LED_KEY2|Equal0~1_combout\,
	datac => \U_LED_KEY2|led_cnt2\(0),
	datad => \U_LED_KEY2|Equal0~0_combout\,
	combout => \U_LED_KEY2|led_cnt2[0]~0_combout\);

-- Location: FF_X28_Y10_N9
\U_LED_KEY2|led_cnt2[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \U_CLOCK_1ms|clk_tmp~clkctrl_outclk\,
	d => \U_LED_KEY2|led_cnt2[0]~0_combout\,
	clrn => \KEY[0]~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \U_LED_KEY2|led_cnt2\(0));

-- Location: LCCOMB_X24_Y10_N2
\Equal2~0\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \Equal2~0_combout\ = (\U_KEY3|sw_ena~q\ & (!\U_KEY2|sw_ena~q\ & (!\U_KEY4|sw_ena~q\ & !\U_KEY1|sw_ena~q\)))
...
-- Equation(s):
-- \m_sele~0_combout\ = (\U_KEY4|sw_ena~q\) # ((\U_KEY3|sw_ena~q\ & ((\U_KEY1|sw_ena~q\) # (\U_KEY2|sw_ena~q\))) # (!\U_KEY3|sw_ena~q\ & (\U_KEY1|sw_ena~q\ $ (!\U_KEY2|sw_ena~q\))))
...
-- pragma translate_on
PORT MAP (
	datab => \U_LED_KEY3|Equal0~1_combout\,
	datac => \U_LED_KEY3|Equal0~0_combout\,
	datad => \U_LED_KEY3|Add1~0_combout\,
...
-- Equation(s):
-- \U_LED_KEY3|Equal0~1_combout\ = (!\U_LED_KEY3|led_cnt\(1) & (\U_LED_KEY3|led_cnt\(3) & (!\U_LED_KEY3|led_cnt\(2) & !\U_LED_KEY3|led_cnt\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY3|led_cnt\(1),
	datab => \U_LED_KEY3|led_cnt\(3),
	datac => \U_LED_KEY3|led_cnt\(2),
	datad => \U_LED_KEY3|led_cnt\(0),
...
-- Equation(s):
-- \U_LED_KEY3|Add1~14_combout\ = \U_LED_KEY3|Add1~13\ $ (\U_LED_KEY3|led_cnt\(7))
...
-- Equation(s):
-- \U_LED_KEY3|led_cnt~0_combout\ = (\U_LED_KEY3|Add1~14_combout\ & ((!\U_LED_KEY3|Equal0~1_combout\) # (!\U_LED_KEY3|Equal0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY3|Equal0~0_combout\,
	datac => \U_LED_KEY3|Add1~14_combout\,
	datad => \U_LED_KEY3|Equal0~1_combout\,
...
-- Equation(s):
-- \U_LED_KEY3|Equal0~0_combout\ = (\U_LED_KEY3|led_cnt\(7) & (\U_LED_KEY3|led_cnt\(6) & (!\U_LED_KEY3|led_cnt\(5) & !\U_LED_KEY3|led_cnt\(4))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY3|led_cnt\(7),
	datab => \U_LED_KEY3|led_cnt\(6),
	datac => \U_LED_KEY3|led_cnt\(5),
	datad => \U_LED_KEY3|led_cnt\(4),
	combout => \U_LED_KEY3|Equal0~0_combout\);

-- Location: LCCOMB_X29_Y11_N4
\U_LED_KEY3|led~0\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_LED_KEY3|led~0_combout\ = \U_LED_KEY3|led~q\ $ (((\U_LED_KEY3|Equal0~0_combout\ & \U_LED_KEY3|Equal0~1_combout\)))
...
-- Equation(s):
-- \Mux4~0_combout\ = (m_sele(2) & (((!m_sele(3) & \U_LED_KEY3|led~q\)))) # (!m_sele(2) & (\U_LED_KEY2|led_cnt2\(0) & (m_sele(3))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY2|led_cnt2\(0),
	datab => m_sele(2),
	datac => m_sele(3),
	datad => \U_LED_KEY3|led~q\,
	combout => \Mux4~0_combout\);

-- Location: LCCOMB_X24_Y10_N14
\Mux4~1\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \Mux4~1_combout\ = (!m_sele(1) & (!m_sele(0) & \Mux4~0_combout\))
...
-- Equation(s):
-- \Mux0~1_combout\ = (m_sele(3)) # ((m_sele(0)) # (m_sele(1) $ (!m_sele(2))))
...
-- Equation(s):
-- \Mux0~0_combout\ = (m_sele(3)) # ((!m_sele(1) & (m_sele(2) & !m_sele(0))))
...
\U_LED_KEY2|led_cnt2[1]~1\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_LED_KEY2|led_cnt2[1]~1_combout\ = \U_LED_KEY2|led_cnt2\(1) $ (((\U_LED_KEY2|Equal0~1_combout\ & (\U_LED_KEY2|led_cnt2\(0) & \U_LED_KEY2|Equal0~0_combout\))))
...
PORT MAP (
	dataa => \U_LED_KEY2|Equal0~1_combout\,
	datab => \U_LED_KEY2|led_cnt2\(0),
	datac => \U_LED_KEY2|led_cnt2\(1),
	datad => \U_LED_KEY2|Equal0~0_combout\,
	combout => \U_LED_KEY2|led_cnt2[1]~1_combout\);

-- Location: FF_X28_Y10_N3
\U_LED_KEY2|led_cnt2[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \U_CLOCK_1ms|clk_tmp~clkctrl_outclk\,
	d => \U_LED_KEY2|led_cnt2[1]~1_combout\,
	clrn => \KEY[0]~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \U_LED_KEY2|led_cnt2\(1));

-- Location: LCCOMB_X29_Y10_N6
\Mux3~0\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \Mux3~0_combout\ = (\Mux0~0_combout\ & (((\Mux0~1_combout\)))) # (!\Mux0~0_combout\ & ((\U_LED_KEY2|led_cnt2\(0)) # ((!\Mux0~1_combout\ & \U_LED_KEY2|led_cnt2\(1)))))
...
PORT MAP (
	...
	datad => \U_LED_KEY2|led_cnt2\(1),
	combout => \Mux3~0_combout\);

-- Location: LCCOMB_X29_Y10_N20
\Mux0~2\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \Mux0~2_combout\ = (\U_LED_KEY2|led_cnt2\(0) & ((m_sele(1)) # ((m_sele(0)) # (m_sele(2)))))
...
PORT MAP (
	...
	datab => m_sele(0),
	datac => m_sele(2),
	datad => \U_LED_KEY2|led_cnt2\(0),
	combout => \Mux0~2_combout\);

-- Location: LCCOMB_X26_Y10_N16
\U_LED_KEY3|led_reg[0]~0\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_LED_KEY3|led_reg[0]~0_combout\ = \U_KEY3|sw_ena~q\ $ (\U_LED_KEY3|led_reg\(0))
...
-- Equation(s):
-- \Mux3~1_combout\ = (\Mux3~0_combout\ & ((\Mux0~2_combout\) # ((!\Mux0~0_combout\)))) # (!\Mux3~0_combout\ & (((\U_LED_KEY3|led_reg\(0) & \Mux0~0_combout\))))
...
\U_LED_KEY2|Mux2~0\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_LED_KEY2|Mux2~0_combout\ = (\U_LED_KEY2|led_cnt2\(1)) # (!\U_LED_KEY2|led_cnt2\(0))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY2|led_cnt2\(1),
	datad => \U_LED_KEY2|led_cnt2\(0),
	combout => \U_LED_KEY2|Mux2~0_combout\);

-- Location: LCCOMB_X26_Y10_N10
\U_LED_KEY3|led_reg[1]~1\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_LED_KEY3|led_reg[1]~1_combout\ = \U_LED_KEY3|led_reg\(1) $ (((\U_KEY3|sw_ena~q\ & \U_LED_KEY3|led_reg\(0))))
...
-- Equation(s):
-- \Mux2~0_combout\ = (\Mux0~0_combout\ & (((\U_LED_KEY3|led_reg\(1)) # (\Mux0~1_combout\)))) # (!\Mux0~0_combout\ & (\U_LED_KEY2|Mux2~0_combout\ & ((!\Mux0~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY2|Mux2~0_combout\,
...
-- Equation(s):
-- \Mux2~1_combout\ = (\Mux0~1_combout\ & (\U_LED_KEY2|led_cnt2\(0) & ((\Mux0~3_combout\) # (!\Mux2~0_combout\)))) # (!\Mux0~1_combout\ & (((\Mux2~0_combout\))))
...
-- Equation(s):
-- \U_LED_KEY3|led_reg[2]~2_combout\ = \U_LED_KEY3|led_reg\(2) $ (((\U_KEY3|sw_ena~q\ & (\U_LED_KEY3|led_reg\(0) & \U_LED_KEY3|led_reg\(1)))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\Mux0~0_combout\ & (((\Mux0~1_combout\)))) # (!\Mux0~0_combout\ & ((\U_LED_KEY2|led_cnt2\(0)) # ((!\Mux0~1_combout\ & !\U_LED_KEY2|led_cnt2\(1)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1100101011001011",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY2|led_cnt2\(0),
...
-- Equation(s):
-- \Mux1~1_combout\ = (\Mux1~0_combout\ & (((\Mux0~2_combout\) # (!\Mux0~0_combout\)))) # (!\Mux1~0_combout\ & (\U_LED_KEY3|led_reg\(2) & (\Mux0~0_combout\)))
...
\U_LED_KEY2|Mux0~0\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_LED_KEY2|Mux0~0_combout\ = (!\U_LED_KEY2|led_cnt2\(0)) # (!\U_LED_KEY2|led_cnt2\(1))
...
PORT MAP (
	dataa => \U_LED_KEY2|led_cnt2\(1),
	datad => \U_LED_KEY2|led_cnt2\(0),
	combout => \U_LED_KEY2|Mux0~0_combout\);

-- Location: LCCOMB_X26_Y10_N12
\U_LED_KEY3|led_reg[3]~3\ : cyclone10lp_lcell_comb
-- Equation(s):
-- \U_LED_KEY3|led_reg[3]~3_combout\ = (\U_LED_KEY3|led_reg\(1) & (\U_LED_KEY3|led_reg\(2) & (\U_KEY3|sw_ena~q\ & \U_LED_KEY3|led_reg\(0))))
...
-- Equation(s):
-- \Mux0~4_combout\ = (\Mux0~0_combout\ & (((\U_LED_KEY3|led_reg\(3)) # (\Mux0~1_combout\)))) # (!\Mux0~0_combout\ & (\U_LED_KEY2|Mux0~0_combout\ & ((!\Mux0~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY2|Mux0~0_combout\,
	datab => \Mux0~0_combout\,
	datac => \U_LED_KEY3|led_reg\(3),
	datad => \Mux0~1_combout\,
...
-- Equation(s):
-- \Mux0~5_combout\ = (\Mux0~1_combout\ & (\U_LED_KEY2|led_cnt2\(0) & ((\Mux0~3_combout\) # (!\Mux0~4_combout\)))) # (!\Mux0~1_combout\ & (((\Mux0~4_combout\))))
