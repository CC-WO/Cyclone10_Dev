...
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~3_combout\ = (!\U_CLOCK_1ms|cnt\(3) & (\U_CLOCK_1ms|cnt\(2) & (\U_CLOCK_1ms|cnt\(0) & \U_CLOCK_1ms|cnt\(1))))
...
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~1_combout\ = (\U_CLOCK_1ms|cnt\(8) & (!\U_CLOCK_1ms|cnt\(11) & (!\U_CLOCK_1ms|cnt\(9) & !\U_CLOCK_1ms|cnt\(10))))
...
PORT MAP (
	...
	datab => \U_CLOCK_1ms|cnt\(11),
	datac => \U_CLOCK_1ms|cnt\(9),
	datad => \U_CLOCK_1ms|cnt\(10),
...
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~0_combout\ = (\U_CLOCK_1ms|cnt\(14) & (!\U_CLOCK_1ms|cnt\(15) & (\U_CLOCK_1ms|cnt\(13) & !\U_CLOCK_1ms|cnt\(12))))
...
-- Equation(s):
-- \U_CLOCK_1ms|Equal0~4_combout\ = (\U_CLOCK_1ms|Equal0~3_combout\ & (\U_CLOCK_1ms|Equal0~1_combout\ & (\U_CLOCK_1ms|Equal0~0_combout\ & \U_CLOCK_1ms|Equal0~2_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_CLOCK_1ms|Equal0~3_combout\,
	datab => \U_CLOCK_1ms|Equal0~1_combout\,
	datac => \U_CLOCK_1ms|Equal0~0_combout\,
...
-- Equation(s):
-- \U_KEY1|chatt2~0_combout\ = (\U_KEY1|chatt1\(2)) # ((\U_KEY1|chatt1\(0)) # ((\U_KEY1|chatt1\(3)) # (\U_KEY1|chatt1\(1))))
...
-- Equation(s):
-- \U_KEY1|Equal0~0_combout\ = (!\U_KEY1|chatt3\(2) & (!\U_KEY1|chatt3\(3) & (!\U_KEY1|chatt3\(1) & \U_KEY1|chatt3\(0))))
...
-- Equation(s):
-- \U_KEY3|chatt2~0_combout\ = (\U_KEY3|chatt1\(0)) # ((\U_KEY3|chatt1\(1)) # ((\U_KEY3|chatt1\(3)) # (\U_KEY3|chatt1\(2))))
...
-- Equation(s):
-- \U_KEY3|Equal0~0_combout\ = (!\U_KEY3|chatt3\(2) & (\U_KEY3|chatt3\(0) & (!\U_KEY3|chatt3\(3) & !\U_KEY3|chatt3\(1))))
...
-- Equation(s):
-- \U_KEY4|chatt2~0_combout\ = (\U_KEY4|chatt1\(2)) # ((\U_KEY4|chatt1\(0)) # ((\U_KEY4|chatt1\(1)) # (\U_KEY4|chatt1\(3))))
...
PORT MAP (
	...
	datab => \U_KEY4|chatt1\(0),
	datac => \U_KEY4|chatt1\(1),
	datad => \U_KEY4|chatt1\(3),
...
-- Equation(s):
-- \U_KEY4|Equal0~0_combout\ = (\U_KEY4|chatt3\(0) & (!\U_KEY4|chatt3\(2) & (!\U_KEY4|chatt3\(3) & !\U_KEY4|chatt3\(1))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY4|chatt3\(0),
	datab => \U_KEY4|chatt3\(2),
...
-- Equation(s):
-- \U_KEY2|Equal0~0_combout\ = (!\U_KEY2|chatt3\(2) & (!\U_KEY2|chatt3\(1) & (!\U_KEY2|chatt3\(3) & \U_KEY2|chatt3\(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_KEY2|chatt3\(2),
	datab => \U_KEY2|chatt3\(1),
	datac => \U_KEY2|chatt3\(3),
	datad => \U_KEY2|chatt3\(0),
...
-- Equation(s):
-- \Equal2~0_combout\ = (!\U_KEY1|sw_ena~q\ & (\U_KEY3|sw_ena~q\ & (!\U_KEY4|sw_ena~q\ & !\U_KEY2|sw_ena~q\)))
...
-- Equation(s):
-- \m_sele~1_combout\ = (\U_KEY1|sw_ena~q\ & (!\U_KEY4|sw_ena~q\ & (!\U_KEY2|sw_ena~q\ & !\U_KEY3|sw_ena~q\))) # (!\U_KEY1|sw_ena~q\ & ((\U_KEY4|sw_ena~q\ & (!\U_KEY2|sw_ena~q\ & !\U_KEY3|sw_ena~q\)) # (!\U_KEY4|sw_ena~q\ & (\U_KEY2|sw_ena~q\ $ 
-- (\U_KEY3|sw_ena~q\)))))
...
PORT MAP (
	...
	datac => \U_LED_KEY1|Equal0~1_combout\,
...
-- Equation(s):
-- \U_LED_KEY1|Equal0~1_combout\ = (!\U_LED_KEY1|led_cnt\(0) & (!\U_LED_KEY1|led_cnt\(1) & (\U_LED_KEY1|led_cnt\(2) & !\U_LED_KEY1|led_cnt\(3))))
...
-- Equation(s):
-- \U_LED_KEY3|led_cnt~2_combout\ = (\U_LED_KEY3|Add1~6_combout\ & ((!\U_LED_KEY3|Equal0~1_combout\) # (!\U_LED_KEY3|Equal0~0_combout\)))
...
PORT MAP (
	...
	datac => \U_LED_KEY3|Equal0~1_combout\,
...
-- Equation(s):
-- \U_LED_KEY3|led_cnt~1_combout\ = (\U_LED_KEY3|Add1~12_combout\ & ((!\U_LED_KEY3|Equal0~1_combout\) # (!\U_LED_KEY3|Equal0~0_combout\)))
...
-- Equation(s):
-- \U_LED_KEY3|Equal0~0_combout\ = (!\U_LED_KEY3|led_cnt\(5) & (!\U_LED_KEY3|led_cnt\(4) & (\U_LED_KEY3|led_cnt\(6) & \U_LED_KEY3|led_cnt\(7))))
...
-- pragma translate_on
PORT MAP (
	dataa => \U_LED_KEY3|Add1~0_combout\,
	datac => \U_LED_KEY3|Equal0~1_combout\,
	datad => \U_LED_KEY3|Equal0~0_combout\,
...
-- Equation(s):
-- \U_LED_KEY3|Equal0~1_combout\ = (!\U_LED_KEY3|led_cnt\(0) & (\U_LED_KEY3|led_cnt\(3) & (!\U_LED_KEY3|led_cnt\(2) & !\U_LED_KEY3|led_cnt\(1))))
...
-- Equation(s):
-- \Equal1~0_combout\ = (!\U_KEY1|sw_ena~q\ & (\U_KEY2|sw_ena~q\ & (!\U_KEY4|sw_ena~q\ & !\U_KEY3|sw_ena~q\)))
...
-- Equation(s):
-- \Equal0~0_combout\ = (\U_KEY1|sw_ena~q\ & (!\U_KEY3|sw_ena~q\ & (!\U_KEY4|sw_ena~q\ & !\U_KEY2|sw_ena~q\)))
...
-- Equation(s):
-- \Mux0~0_combout\ = (\U_LED_KEY1|led~q\ & ((m_sele(1)) # ((m_sele(0)) # (m_sele(2)))))
...
-- Equation(s):
-- \U_LED_KEY2|led_cnt~0_combout\ = (\U_LED_KEY2|led_cnt\(0) & ((\U_LED_KEY2|led_cnt\(2) $ (\U_LED_KEY2|led_cnt\(1))))) # (!\U_LED_KEY2|led_cnt\(0) & (\U_LED_KEY2|led_cnt\(2) & ((\U_LED_KEY2|led_cnt\(3)) # (\U_LED_KEY2|led_cnt\(1)))))
...
-- Equation(s):
-- \U_LED_KEY2|led_cnt[3]~1_combout\ = \U_LED_KEY2|led_cnt\(3) $ (((\U_LED_KEY2|led_cnt\(1) & (\U_LED_KEY2|led_cnt\(2) & \U_LED_KEY2|led_cnt\(0)))))
...
-- Equation(s):
-- \U_LED_KEY2|Equal0~0_combout\ = (!\U_LED_KEY2|led_cnt\(1) & (\U_LED_KEY2|led_cnt\(2) & (!\U_LED_KEY2|led_cnt\(3) & !\U_LED_KEY2|led_cnt\(0))))
...
-- Equation(s):
-- \Mux0~1_combout\ = (m_sele(3)) # ((m_sele(2) & (!m_sele(0) & !m_sele(1))))
...
-- Equation(s):
-- \Mux0~3_combout\ = (m_sele(1)) # ((m_sele(0)) # (m_sele(2)))
...
-- Equation(s):
-- \Mux2~1_combout\ = (\Mux0~2_combout\ & (\Mux2~0_combout\)) # (!\Mux0~2_combout\ & ((\Mux2~0_combout\ & ((\U_LED_KEY3|led_reg\(1)))) # (!\Mux2~0_combout\ & (!\U_LED_KEY2|led_sftreg\(1)))))
...
-- Equation(s):
-- \Mux1~1_combout\ = (\Mux1~0_combout\ & (((\U_LED_KEY3|led_reg\(2))) # (!\Mux0~1_combout\))) # (!\Mux1~0_combout\ & (\Mux0~1_combout\ & ((\Mux0~0_combout\))))
...
-- Equation(s):
-- \U_LED_KEY3|led_reg[3]~3_combout\ = (\U_LED_KEY3|led_reg\(0) & (\U_KEY3|sw_ena~q\ & (\U_LED_KEY3|led_reg\(1) & \U_LED_KEY3|led_reg\(2))))
...
-- Equation(s):
-- \Mux0~4_combout\ = (\Mux0~2_combout\ & (((\Mux2~0_combout\)))) # (!\Mux0~2_combout\ & ((\Mux2~0_combout\ & (\U_LED_KEY3|led_reg\(3))) # (!\Mux2~0_combout\ & ((!\U_LED_KEY2|led_sftreg\(3))))))
